...
export default function Page() {
    return (
        <div className="text-lg">
            Privacy Policy for ParseHog.com

            Last Updated: January 15, 2024

            1. Introduction

            Welcome to ParseHog.com. We are committed to safeguarding the privacy of our website visitors and service users. This policy applies where we are acting as a data controller with respect to the personal data of our website visitors and service users; in other words, where we determine the purposes and means of the processing of that personal data.

            2. Credit

            This document was created using a template from SEQ Legal (seqlegal.com) and modified by ParseHog.com.
            ...
            The payment of a fee [if legally permissible].
